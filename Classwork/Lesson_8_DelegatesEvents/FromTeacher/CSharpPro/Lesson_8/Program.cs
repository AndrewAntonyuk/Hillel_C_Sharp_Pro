...
namespace Lesson8
{
    ...
    //{
    //    public int sum;
    //    public AccountHandler? taken { get; set; }
    //    public Account(int sum) => this.sum = sum;
    //    // Реєструємо делегат
    //    public void RegisterHandler(AccountHandler del)
    //    {
    ...
    //        {
    //            this.sum -= sum;
    //            taken?.Invoke(this, new AccountEventArgs($"З рахунку списано {sum} у.о.", sum));
    //        }
    //        else
    //            taken?.Invoke(this, new AccountEventArgs($"Недостатньо коштів. Баланс: {this.sum} у.о.", sum));
    //    }
    //}
