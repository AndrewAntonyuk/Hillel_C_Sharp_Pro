...
VALUES (25, 'Gorge', 'Smith', 'smith@gmail.com', '0123654789'),
       (DEFAULT, 'John', 'Holt', 'holt@gmail.com', '0312645978'),
       (43, 'Lisa', 'Mashrow', 'lmash@gmail.com', '0132465798'),
       (55, 'Jorga', 'Japuga', 'japa@gmail.com', '0963258741'),
       (15, 'Rachel', 'Aniston', 'ana@gmail.com', '0789456123')
...
(
    ...
    CONSTRAINT FK_Order_To_Customers FOREIGN KEY (CustomerId)  REFERENCES Customers (Id)
);

ALTER TABLE Orders
ADD CONSTRAINT FK_Order_To_Customers FOREIGN KEY(CustomerId) REFERENCES Customers(Id) ON DELETE NO ACTION


ALTER TABLE Orders
DROP FK_Order_To_Customers
...
SELECT ProductName + ' (' + Manufacturer + ')' AS 'Full name', Price, Price * ProductCount AS 'Total cost'
FROM Products
...
--
SELECT * , Price * ProductCount AS TotalPrice 
FROM Products
...
FROM (SELECT TOP 2 *
      FROM Products 
      WHERE TRIM(Manufacturer)= 'Apple') AS Selected
...
WHERE Manufacturer='Apple FF') AS Selected
WHERE Products.Id = Selected.Id
...
(
     ...
     CONSTRAINT PK_CustomerId PRIMARY KEY(Id1, Id2, Id3, Id4),
     CONSTRAINT UQ_Customer_TestName UNIQUE([TestName])
)

INSERT INTO Customers1
VALUES (1, 0, 1, 2, 'Name1', 'UniqueName1'),
       (1, 0, 1, 3, 'Name2', 'UniqueName2'),
       (1, 0, 1, 4, 'Name3', 'UniqueName3'),
       (1, 0, 1, 5, 'Name4', 'UniqueName4'),
       (1, 0, 1, 6, 'Name5', 'UniqueName5')

INSERT INTO Customers1  -- ERR because primary key can't be not unique
VALUES  (1, 0, 2, 6, 'Name100', 'Blalalal')
...
(
    ...
    CustomerId3 INT NOT NULL,
    CustomerId4 INT NOT NULL,
    [CustomerTestName] NVARCHAR(100) NOT NULL,

    CONSTRAINT FK_Orders_To_Customers FOREIGN KEY(CustomerId1,CustomerId2,CustomerId3,CustomerId4) 
                                      REFERENCES Customers1(Id1, Id2, Id3, Id4)
                                      ON DELETE CASCADE
                                      ON UPDATE CASCADE
)

INSERT INTO Orders1
VALUES (1, 0, 1, 2, 'UniqueName1'),
       (1, 0, 1, 2, 'UniqueName1'),
       (1, 0, 1, 2, 'UniqueName4'),
       (1, 0, 1, 4, 'UniqueName4'),
       (1, 0, 1, 4, 'UniqueName5'),
...
DELETE Customers1
WHERE Id2 = 4 and Id3 = 1

UPDATE Customers1
SET Id1 = 3, Id2 = 4, Id4 = 0
WHERE Id4 = 6

UPDATE Customers1
SET [TestName] = 'TestName12'
WHERE Id4 = 6
