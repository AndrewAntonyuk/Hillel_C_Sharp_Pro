...
namespace InternetShop.Migrations
{
    ...
    partial class InternetShpoDbContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("InternetShop.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 22,
                            Address = "test-1",
                            CreatedAt = new DateTime(2023, 10, 22, 17, 10, 53, 670, DateTimeKind.Utc).AddTicks(5214),
                        ...
                        new
                        {
                            Id = 25,
                            Address = "test-2",
                            CreatedAt = new DateTime(2023, 10, 22, 17, 10, 53, 670, DateTimeKind.Utc).AddTicks(5227),
