...
namespace TiaOpennessHelper
{
    public partial class OpennessHelper
    {
        ...
        /// <summary>
        /// Searches recursively through the PlcSoftware to find the PlcWatchTable with given name.
        /// </summary>
        /// <param name="plcSoftware">PlcSoftware to be searched</param>
        /// <param name="watchTableName">Name to be searched for</param>
        /// <returns>Reference to found PlcWatchTable</returns>
        /// <exception cref="System.ArgumentNullException">Parameter is null;PlcSoftware</exception>
        /// <exception cref="System.ArgumentException">Parameter is null or empty;watchTableName</exception>
        public static PlcWatchTable FindPlcWatchTableByName(PlcSoftware plcSoftware, string watchTableName)
        {
            if (plcSoftware == null)
                throw new ArgumentNullException(nameof(plcSoftware), "PlcSoftware");
            if (string.IsNullOrEmpty(watchTableName))
                throw new ArgumentException("Parameter is null or empty", nameof(watchTableName));

            return RecursiveFindElementByName(plcSoftware.WatchAndForceTableGroup, watchTableName) as PlcWatchTable;
        }
