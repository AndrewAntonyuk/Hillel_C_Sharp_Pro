...
namespace TiaOpennessHelper
{
    public partial class OpennessHelper
    {
        ...
        public static void ExportStructure(IEngineeringCompositionOrObject elementToExport, ExportOptions exportOptions, string exportPath)
        {
            ...
            if (elementToExport is PlcBlock || elementToExport is PlcTagTable || elementToExport is PlcType || elementToExport is PlcExternalSource || elementToExport is PlcWatchTable
                ...
                || elementToExport is VBScript || elementToExport is TextList || elementToExport is ScreenPopup || elementToExport is ScreenSlidein || elementToExport is PlcWatchTable)
            {
        ...
        public static string ExportItem(IEngineeringObject exportItem, ExportOptions exportOption, string exportPath)
        {
            ...
            if (exportItem is PlcTagTable || exportItem is PlcType
                || exportItem is PlcWatchTable
                || exportItem is ScreenOverview || exportItem is ScreenGlobalElements
                ...
                || exportItem is VBScript || exportItem is ScreenPopup || exportItem is ScreenSlidein || exportItem is PlcWatchTable)
            {
